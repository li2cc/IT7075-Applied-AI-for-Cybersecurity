...
so the part is reproducible offline. Do NOT point these tools at systems you
are not explicitly authorized to test.

Run it directly (stdio transport, the MCP default):
    python recon_server_web.py
Or let a client spawn it over stdio (see part3_web_pentest_real.ipynb).
"""
import ssl
