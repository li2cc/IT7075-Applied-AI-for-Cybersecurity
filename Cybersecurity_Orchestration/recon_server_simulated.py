...
output for a few fictional lab hosts so the part is reproducible and safe.
...
Run it directly (stdio transport, the MCP default):
    ...
    python recon_server_simulated.py

Or let a client spawn it over stdio (see part2_orchestration_simulated.ipynb).
"""
